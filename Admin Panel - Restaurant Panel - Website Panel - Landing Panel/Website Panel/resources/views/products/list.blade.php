...
<script type="text/javascript">
    ...
    function buildCategoryHTML(snapshots){
     ...
     async function getProducts(type,id){
		...
		var vendorsSnapshots = await geoFirestore.collection('vendors').database.collection('vendors').near({
