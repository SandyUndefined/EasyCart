...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="form-group col-12 text-center btm-btn">
            <button type="button" class="btn btn-primary  save_restaurant_btn"><i class="fa fa-save"></i> {{trans('lang.save')}}
            </button>
    ...
    async function storeGalleryImageData() {
        ...
        if (new_added_restaurant_photos.length > 0) {
            await Promise.all(new_added_restaurant_photos.map(async (resPhoto, index) => {
                ...
                var uploadTask = await storageRef.child(new_added_restaurant_photos_filename[index]).putString(resPhoto, 'base64', {
                    contentType: 'image/jpg'
                });
                var downloadURL = await uploadTask.ref.getDownloadURL();
