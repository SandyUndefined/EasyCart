                            ...
                            <table id="foodTable" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="delete-all"><input type="checkbox" id="select-all"><label class="col-3 control-label" for="select-all">
...
<script type="text/javascript">
    ...
    ref.get().then(async function(snapshots) {
        ...
        jQuery.fn.dataTable.ext.type.order['formatted-num-pre'] = function(a) {
    ...
    async function getListData(val) {
        ...
        if (checkDeletePermission) {
        html = html + '<a id="' + val.id + '" name="food-delete" href="javascript:void(0)" class="link-td do_not_delete"><i class="fa fa-trash"></i></a></td>';
        }
