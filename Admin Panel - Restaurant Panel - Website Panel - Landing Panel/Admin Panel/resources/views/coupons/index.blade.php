...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        html = html + '<td><a href="' + route1 + '"  class="redirecttopage">' + val.code + '</a></td>';
        ...
        if (checkDeletePermission) {
        html = html + '<a id="' + val.id + '" name="coupon_delete_btn" class="do_not_delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
        }
