...
<script type="text/javascript">
    ...
    function buildHTML(snapshots) {
        ...
        snapshots.docs.forEach(async (listval) => {
            ...
            if (checkDeletePermission) {
            html = html + '<td class="delete-all"><input type="checkbox" name="record" id="is_open_' + id + '" class="is_open" data-id="' + id + '" style="width:30px;"><label class="col-3 control-label"\n' +
            ...
            if (checkDeletePermission) {
                html=html+'<a id="' + val.id + '" name="vendor-delete" class="do_not_delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
            }
