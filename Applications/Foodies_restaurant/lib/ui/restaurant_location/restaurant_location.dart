...
class RestaurantLocationScreen extends StatefulWidget {
  final desc, phonenumber, filter, catid, restname, pic, deliveryChargeModel, cat, zoneId;
  VendorModel? vendor;

  RestaurantLocationScreen({Key? key, required this.desc,required this.phonenumber,required this.catid,required this.pic,required this.filter,required this.restname,required this.vendor, required this.cat, required this.deliveryChargeModel, required this.zoneId})
      : super(key: key);
...
class _RestaurantLocationScreenState extends State<RestaurantLocationScreen> {
  ...
  addRestaurant() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      await showProgress('Adding Restaurant...'.tr(), false);
  ...
  updateRestaurant(add) async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      _formKey.currentState!.save();
      await showProgress('Updating Restaurant...'.tr(), false);
