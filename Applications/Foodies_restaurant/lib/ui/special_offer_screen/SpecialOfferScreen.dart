...
class _SpecialOfferScreenState extends State<SpecialOfferScreen> {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                setState(() {
                                  specialDiscount[index].timeslot!.add(Timeslot(from: '', to: '', discount: '', type: 'percentage', discountType: 'delivery'));
                                });
                              },
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          onTap: () async {
                                            ...
                                            setState(() {
                                              specialDiscount[index].timeslot![index1].from = DateFormat('HH:mm')
                                        ...
                                        Expanded(
                                            child: InkWell(
                                          onTap: () async {
                                            TimeOfDay? endTimeOfDay = await _selectTime();
                                            ...
                                            if (endTimeOfDay != null) {
                                              ...
                                              DateTime time = new DateFormat("HH:mm").parse(specialDiscount[index].timeslot![index1].from.toString());
            ...
            if (MyAppState.currentUser!.vendorID.isEmpty) {
              ...
              specialDiscount.forEach((element) {
                ...
                var emptyList = element.timeslot!.where((element) =>
                    element.discount!.isEmpty || element.from!.isEmpty || element.to!.isEmpty || (element.type == "percentage" && double.parse(element.discount.toString()) > 100));
                // var discount = element.timeslot!.where((element) => element.discountType == "percentage" && double.parse(element.discount.toString()) >  100);
  ...
  saveSpecialOffer() async {
    await showProgress('Update Special discount...', false);
