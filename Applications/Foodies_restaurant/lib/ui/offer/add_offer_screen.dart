                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            }else if(_result == "Percentage" && double.parse(value.toString()) > 99){
                               return 'Percentage is less than 100';
                             }
                            return null;
                          },
                          decoration: InputDecoration(
            ...
            GestureDetector(
              onTap: () async {
                if (_formKey.currentState?.validate() == false) {
                  ...
                  await showProgress( widget.offerModel == null ? 'Adding Offer...'.tr() : "Editing Offer...".tr(), false);
