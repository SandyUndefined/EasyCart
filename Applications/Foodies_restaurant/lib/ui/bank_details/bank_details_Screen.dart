...
import 'package:foodie_restaurant/model/FlutterWaveSettingDataModel.dart';
import 'package:foodie_restaurant/model/User.dart';
import 'package:foodie_restaurant/model/paypalSettingData.dart';
import 'package:foodie_restaurant/model/razorpayKeyModel.dart';
import 'package:foodie_restaurant/model/stripeSettingData.dart';
import 'package:foodie_restaurant/model/withdraw_method_model.dart';
          ...
          child: isLoading == true
              ...
              : Column(
                  ...
                  children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "Bank Transfer",
                                        style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinsl", color: Colors.black, fontSize: 16),
                                      )
                                    ],
                                  ),
                                  isBankDetailsAdded
                              ...
                              child: isBankDetailsAdded
                                  ...
                                  : Row(
                                      children: [
                                        Text(
                                          "Setup is Pending.".tr(),
                                          style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinsl", color: Colors.orange),
                                        ),
                                        SizedBox(
                                          width: 5,
                                        ),
                                        InkWell(
                                          ...
                                          child: Text(
                                            "Setup Now".tr(),
                                            style: TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontFamily: "Poppinsl", color: Colors.blue),
                                          ),
                                        ),
                                      ],
                                    ),
                    ...
                    flutterWaveSettingData != null && flutterWaveSettingData!.isWithdrawEnabled == false?SizedBox():Card(
                      color: isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Colors.white,
                      elevation: 2,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10), // if you need this
                    ...
                    paypalDataModel != null && paypalDataModel!.isWithdrawEnabled == false?SizedBox():Card(
                      color: isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Colors.white,
                      elevation: 2,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10), // if you need this
                    ...
                    razorPayModel != null && razorPayModel!.isWithdrawEnabled == false?SizedBox():Card(
                      color: isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Colors.white,
                      elevation: 2,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10), // if you need this
                    ...
                    stripeSettingData != null && stripeSettingData!.isWithdrawEnabled == false?SizedBox():Card(
                      color: isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Colors.white,
                      elevation: 2,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10), // if you need this
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: withdrawMethodModel!.stripe != null
                                  ? Text(
                                      "Setup was Done",
                                      style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinsl", color: withdrawMethodModel!.paypal != null ? Colors.green : Colors.red),
                                    )
                                  : Row(
                                      children: [
                                        Text(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinsl", color: isDarkMode(context) ? Colors.white : Colors.grey),
                ),
              ),
              SizedBox(
                height: 20,
