...
import 'package:foodie_restaurant/ui/online_registration/online_registartion_screen.dart';
...
class _ContainerScreen extends State<ContainerScreen> {
  ...
  void initState() {
    ...
    if (isRestaurantVerification == true && MyAppState.currentUser!.isDocumentVerify == false) {
      _drawerSelection = DrawerSelection.documentVerification;
      _appBarTitle = 'Document Verification'.tr();
      _currentWidget = OnlineRegistrationScreen();
    }
    getSpecialDiscount();
      ...
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            ...
            isRestaurantVerification == true && MyAppState.currentUser!.isDocumentVerify == false
                ? SizedBox()
                : ListTileTheme(
            ...
            isRestaurantVerification == true
                ? ListTileTheme(
                    style: ListTileStyle.drawer,
                    selectedColor: Color(COLOR_PRIMARY),
                    child: ListTile(
                      selected: _drawerSelection == DrawerSelection.documentVerification,
                      leading: Icon(Icons.document_scanner),
                      title: Text('Document Verification').tr(),
                      onTap: () {
                        Navigator.pop(context);
                        setState(() {
                          _drawerSelection = DrawerSelection.documentVerification;
