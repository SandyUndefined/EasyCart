                              ...
                              : Align(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        "${amountShow(amount: (double.parse(widget.orderModel.products[index].extrasPrice.toString()) * double.parse(widget.orderModel.products[index].quantity.toString())).toString())}",
                                        maxLines: 2,
