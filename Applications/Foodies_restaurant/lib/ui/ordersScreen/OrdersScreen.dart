...
import 'package:foodie_restaurant/services/send_notification.dart';
                      ...
                      child: Row(
                        children: [
                          ...
                          orderModel.estimatedTimeToPrepare == null
                              ? Text("00:00")
                              : Text(orderModel.estimatedTimeToPrepare.toString() +
                    ...
                    return Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          trailing: Text(
                            amountShow(
                                amount: (double.parse(orderModel.products[index].price.toString()) * double.parse(orderModel.products[index].quantity.toString())).toString()),
                              ...
                              : Align(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        "${amountShow(amount: (double.parse(orderModel.products[index].extrasPrice.toString()) * double.parse(orderModel.products[index].quantity.toString())).toString())}",
                                        maxLines: 2,
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              await SendNotification.sendFcmMessage(restaurantRejected, orderModel.author.fcmToken,{});
                              ...
                              if (orderModel.paymentMethod.toLowerCase() != 'cod') {
                                ...
                                await FireStoreUtils.createPaymentId().then((value) {
                                  ...
                                  FireStoreUtils.topUpWalletAmount(paymentMethod: "Refund Amount".tr(), userId: orderModel.author.userID, amount: finalAmount, id: paymentID)
                                      .then((value) {
                          ...
                          ? Expanded(
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  await SendNotification.sendFcmMessage(takeawayCompleted, orderModel.author.fcmToken,{});
                                },
                                child: Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (estimatedTime.text.isNotEmpty) {
                            ...
                            await SendNotification.sendFcmMessage(restaurantAccepted, orderModel.author.fcmToken,{});
