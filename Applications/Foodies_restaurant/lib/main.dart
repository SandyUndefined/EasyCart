...
class MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initializeFlutterFire() async {
    try {
      ...
      await FirebaseFirestore.instance.collection(Setting).doc("document_verification_settings").get().then((value) {
        print("=============>");
        print(value.data());
        isRestaurantVerification = value.data()!['isRestaurantVerification'];
      });
