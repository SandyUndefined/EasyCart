...
import 'package:foodie_driver/services/send_notification.dart';
...
class HomeScreenState extends State<HomeScreen> {
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      try {
                        await showProgress(context, 'Rejecting order...'.tr(), false);
                        await rejectOrder();
                        await hideProgress();
                      } catch (e) {
                        await hideProgress();
  ...
  acceptOrder() async {
    await showProgress(context, 'Accepting order...'.tr(), false);
    ...
    await hideProgress();
    await SendNotification.sendFcmMessage(driverAccepted, currentOrder!.author.fcmToken,{});
    await SendNotification.sendFcmMessage(driverAccepted, currentOrder!.vendor.fcmToken,{});
    setState(() {
      isShow = true;
    });
  }
  ...
  completeOrder() async {
    await showProgress(context, 'Completing Delivery...'.tr(), false);
    currentOrder!.status = ORDER_STATUS_COMPLETED;
    updateWallateAmount(currentOrder!);
    await FireStoreUtils.updateOrder(currentOrder!);
    await SendNotification.sendFcmMessage(driverCompleted, currentOrder!.author.fcmToken,{});
