...
class _NewOrderScreenState extends State<NewOrderScreen> {
  ...
  acceptOrder(OrderModel orderModel) async {
    ...
    await SendNotification.sendFcmMessage(driverAccepted, orderModel.author.fcmToken, {});
    await SendNotification.sendFcmMessage(driverAccepted, orderModel.vendor.fcmToken, {});
  }
}
