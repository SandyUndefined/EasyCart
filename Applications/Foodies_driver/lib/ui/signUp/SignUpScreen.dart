...
class _SignUpState extends State<SignUpScreen> {
  ...
  _signUp() async {
    if (_key.currentState?.validate() ?? false) {
      ...
      if(selectedZoneList == null){
        showAlertDialog(context, 'Alert'.tr(),"To sign up, you must choose a zone.  without selecting a zone sign-up is not an option.",true);
      }else{
  ...
  _signUpWithEmailAndPassword() async {
    ...
    dynamic result =
        await FireStoreUtils.firebaseSignUpWithEmailAndPassword(email!.trim(), password!.trim(), _image, _carImage, firstName!, lastName!, mobile!,selectedZoneList!.id.toString());
    await hideProgress();
