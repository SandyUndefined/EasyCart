...
class HomeScreenState extends State<HomeScreen> {
  ...
  acceptOrder(User user) async {
    ...
    await FireStoreUtils.sendFcmMessageMultiple(
        "Delivery Agent Assigned.".tr(), user.firstName + " " + user.lastName + " will deliver Your Order.", orderModel.author.fcmToken, orderModel.vendor.fcmToken);
  }
  ...
  completeOrder() async {
    ...
    await FireStoreUtils.updateOrder(currentOrder!);
    await FireStoreUtils.sendFcmMessageMultiple("Order Complete".tr(), "Our Delivery agent delivered order.".tr(), currentOrder!.author.fcmToken, null);
